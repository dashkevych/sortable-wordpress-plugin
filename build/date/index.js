...
/* harmony export */   is12HourFormat: function() { return /* binding */ is12HourFormat; }
/* harmony export */ });
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/date/editor.scss");
...
function Edit(props) {
  ...
  const {
    ...
    return {
      ...
      getBlock: select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.store).getBlock
    };
  }, []);
  const {
    selectBlock
  ...
  const entryDate = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("time", {
    dateTime: (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_3__.format)('c', date)
  }, (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_3__.format)(attributes.format || siteFormat, date));
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.__experimentalDateFormatPicker, {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Change date', 'sortable')))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...blockProps
  }, entryDate));
}
 ...
 */
function is12HourFormat(dateFormat) {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/date/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/date/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/date/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/date/block.json");
/**
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"sortable/date","version":"1.4.3","title":"Sortable Date","category":"widgets","icon":"calendar","description":"Since this block is dependent on the Sortable Entry block, it displays the date set in it and also allows to customize how the date is displayed by providing the option to change the date format.","ancestor":["sortable/entry"],"attributes":{"format":{"type":"string"}},"supports":{"html":false,"color":{"gradients":true,"link":false,"__experimentalDefaultControls":{"background":true,"text":true}},"spacing":{"padding":true},"typography":{"fontSize":true,"lineHeight":true,"__experimentalFontFamily":true,"__experimentalFontWeight":true,"__experimentalFontStyle":true,"__experimentalTextTransform":true,"__experimentalTextDecoration":true,"__experimentalLetterSpacing":true,"__experimentalDefaultControls":{"fontSize":true}}},"usesContext":["sortable/entryDateTime"],"textdomain":"sortable","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["date/style-index"], function() { return __webpack_require__("./src/date/index.js"); })
